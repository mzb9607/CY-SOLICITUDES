package com.bancolombia.crediya.redis.helper;
...
public abstract class ReactiveTemplateAdapterOperations<E, K, V> {
    ...
    // En ReactiveTemplateAdapterOperations
    ...
    @SuppressWarnings("unchecked")
    protected List<E> toEntityList(V data) {
        return data != null ? (List<E>) data : null;
    }

    protected ReactiveRedisTemplate<K, V> getTemplate() {
